...
export default function Navbar() {
  ...
  return (
    <header className="h-16 border-b border-slate-800 bg-slate-950/80 backdrop-blur-xl px-4 flex items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        {searchOpen && (
          <div ref={searchRef} className="fixed inset-0 z-50 flex items-start justify-center pt-20 bg-black/60 backdrop-blur-sm">
        ...
        <div className="relative" ref={notifRef}>
          ...
          {notifOpen && (
            <div className="absolute right-0 top-12 w-80 sm:w-96 rounded-2xl glass-panel border border-slate-700/60 shadow-2xl shadow-black/50 overflow-hidden animate-fade-in">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {profileOpen && (
            <div className="absolute right-0 top-12 w-64 rounded-2xl glass-panel border border-slate-700/60 shadow-2xl shadow-black/50 overflow-hidden animate-fade-in">
